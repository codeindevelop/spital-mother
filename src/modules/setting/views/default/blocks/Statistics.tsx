  ...
  const renderItems = (item: IStatisticsItem, index: number) => {
    return (
      <React.Fragment key={index}>
        <div className="grid grid-cols-1 place-content-center flex-1 gap-1 text-center w-full">
          <span className="text-gray-900 text-2xl lg:text-2.5xl leading-none font-estedad font-semibold">
            {item.number}
          </span>
