...
import { SeoArticleSettingsPageContent } from './SeoArticleSettingsPageContent';

const SeoArticleSettingsPage = () => {
  ...
  return (
    <Fragment>
          ...
          <Toolbar>
            ...
            <ToolbarActions>
              <Link to="/user/create" className="btn btn-sm btn-primary">
                ...
                ایجاد کاربر جدیدSeoArticleSettingsPage
              </Link>
            </ToolbarActions>
          </Toolbar>
        </Container>
      ...
      <Container>
        <SeoArticleSettingsPageContent />
      </Container>
    </Fragment>
  );
};

export { SeoArticleSettingsPage };
