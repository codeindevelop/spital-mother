...
import { SeoArticleCategorySettingPageContent } from './SeoArticleCategorySettingPageContent';

const SeoArticleCategorySettingPage = () => {
  ...
  return (
    <Fragment>
      ...
      <Container>
        <SeoArticleCategorySettingPageContent />
      </Container>
    </Fragment>
  );
};

export { SeoArticleCategorySettingPage };
