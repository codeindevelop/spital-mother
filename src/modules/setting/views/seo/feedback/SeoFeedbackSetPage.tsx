...
import { SeoFeedbackSetPageContent } from './SeoFeedbackSetPageContent';

const SeoFeedbackSetPage = () => {
  ...
  return (
    <Fragment>
          ...
          <Toolbar>
            ...
            <ToolbarActions>
              <Link to="/user/create" className="btn btn-sm btn-primary">
                ...
                ایجاد کاربر جدیدSeoFeedbackSetPageContent
              </Link>
            </ToolbarActions>
          </Toolbar>
        </Container>
      ...
      <Container>
        <SeoFeedbackSetPageContent />
      </Container>
    </Fragment>
  );
};

export { SeoFeedbackSetPage };
