...
import { SeoProductSettingPageContent } from './SeoProductSettingPageContent';

const SeoProductSettingPage = () => {
  ...
  return (
    <Fragment>
          ...
          <Toolbar>
            ...
            <ToolbarActions>
              <Link to="/user/create" className="btn btn-sm btn-primary">
                ...
                ایجاد کاربر جدید SeoProductSettingPageContent
              </Link>
            </ToolbarActions>
          </Toolbar>
        </Container>
      ...
      <Container>
        <SeoProductSettingPageContent />
      </Container>
    </Fragment>
  );
};

export { SeoProductSettingPage };
