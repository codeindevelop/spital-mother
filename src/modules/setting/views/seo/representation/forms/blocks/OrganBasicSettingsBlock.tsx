          ...
          <div className="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
            ...
            <div className="w-full">
              ...
              <p className="text-right text-gray-800 text-sm font-normal leading-6 my-2">
                حتی اگر نام شرکت شما به صورت کامل در وب‌سایت شما ذکر شده است، این فیلد را پر کنید.
                این نام جایگزین به گوگل کمک می‌کند تا درک بهتری از برند شما داشته باشد و در صورت
                نیاز، از آن در نتایج جستجو استفاده کند.
              </p>
