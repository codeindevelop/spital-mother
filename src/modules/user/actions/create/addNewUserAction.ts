...
const addNewUserAction = createAsyncThunk(
  'addUser/addNewUser',
  async (userData: AddNewUserPayload, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.post(cruds.addNewUserUrl, userData, config);
